...
local function build_train_schedule_group_report(player)
    ...
    local enabled_hidden_keywords = get_enabled_hidden_keywords(player)
    ...
    for _, surface_train_schedule_groups_pair in pairs(surface_train_schedule_groups_pairs) do
        ...
        if not (player_global.only_current_surface and surface.name ~= player.surface.name) then
            ...
            for _, schedule_name in pairs(sorted_schedule_names) do
                ...
                for _, keyword in pairs(get_enabled_hidden_keywords(player)) do
                ...
                if (
                    ...
                    and (player_global.show_satisfied or (not satisfied))
                    and (player_global.show_invalid or (not invalid))
                ) then
