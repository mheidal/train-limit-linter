...
---@field validate fun(self: TLLTrainList): boolean Check every tracked train's .valid attribute and remove falsy trains. Returns true if any trains were removed, false if no trains were removed.
