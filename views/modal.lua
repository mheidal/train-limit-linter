...
local modal_content_frame_imports = {
    require("views.modals.export_keywords_modal"),
}
...
---@param titlebar_caption LocalisedString
...
function Exports.build_modal(player, titlebar_caption, modal_function, args)
    ...
    modal_main_frame.style.size = {350, 200}
    ...
    titlebar_flow.add{type="label", style="frame_title", caption=titlebar_caption}
...
---@param player LuaPlayer
---@param modal_caption LocalisedString?
---@param modal_function string?
---@param args table?
function Exports.toggle_modal(player, modal_caption, modal_function, args)
    ...
    if modal_main_frame == nil then
        ...
        Exports.build_modal(player, modal_caption, modal_function, args)
    else
