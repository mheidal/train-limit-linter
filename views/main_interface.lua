...
function Exports.build_interface(player)
    ...
    if not player_global.view.main_frame then
        ...
        local elems = gui.lib.add(
            tabbed_pane,
            {
                {
                    tab={type="tab", caption={"tll.display_tab"}},
                    content={type="frame", direction="vertical", style="tll_tab_content_frame", name=element_names.display_tab_content_frame}
                },
                {
                    tab={type="tab", caption={"tll.exclude_tab"}},
                    content={type="frame", direction="vertical", style="tll_tab_content_frame", name=element_names.exclude_tab_content_frame}
                },
                {
                    tab={type="tab", caption={"tll.hide_tab"}},
                    content={type="frame", direction="vertical", style="tll_tab_content_frame", name=element_names.hide_tab_content_frame}
                },
                {
                    tab={type="tab", caption={"tll.settings_tab"}},
                    content={type="frame", direction="vertical", style="tll_tab_content_frame", name=element_names.settings_tab_content_frame}
                },
            }
        )

        player_global.view.display_content_frame = elems[element_names.display_tab_content_frame]
        player_global.view.exclude_content_frame = elems[element_names.exclude_tab_content_frame]
        player_global.view.hide_content_frame = elems[element_names.hide_tab_content_frame]
        player_global.view.settings_content_frame = elems[element_names.settings_tab_content_frame]

        -- -- display tab
        -- local display_tab = tabbed_pane.add{type="tab", caption=, tags={action=constants.actions.main_interface_switch_tab, tab_index=1}}
